...
# use old build from extracts/ as the github npm registry one crashes on restore
cp ./extract/libv86.js dist/
cp ./extract/v86.wasm dist/
cp ./extract/seabios.bin dist/
cp ./extract/vgabios.bin dist/
